...
public class FXMLController {
	private Model model; //definisco nel controller model e lo importo.
	//il modello lo creo nell'EntryPoint
    ...
    void doNuovaPartita(ActionEvent event) {
    	...
    	//gestione interfaccia (deve stare qua)
    ...
    void doTentativo(ActionEvent event) {
    	...
    	risultato = this.model.tentativo(tentativo);
    		...
    		txtRisultato.setText(ip.getMessage()); //con getMessage() recupero il messaggio che avevo già scritto nel model
    		return;
    ...
    //inizializzo il metodo setModel
